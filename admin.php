                ...
                <tr>
                    ...
                    <td>
                        <select name="cookielaw_script_position" id="cookielaw_script_position">
                            <option value='head' <?php echo get_option('cookielaw_script_position') == 'head' || !get_option('cookielaw_script_position') ? "selected='selected'" : null; ?>><?php _e('WP Head', 'cookielaw-eu') ?></option>
                ...
                <tr>
                    ...
                    <td>
                        <select name="cookielaw_language" id="cookielaw_language">
                            <option value='browser' <?php echo get_option('cookielaw_language') == 'browser' || !get_option('cookielaw_language') ? "selected='selected'" : null; ?>><?php _e('Based on user browser', 'cookielaw-eu') ?></option>
